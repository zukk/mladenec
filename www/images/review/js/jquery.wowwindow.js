...
$.fn.wowwindow = function(o) {
    var defaults = {
        ...
        closeButton: '<a class="wowwindow-close" id="wowwindow-close" title="close" href="javascript:jQuery(document.body).overlayPlayground(\'close\');void(0)">Close</a>',
        ...
        afterHTML: '<div id="wowwindow-footer">&nbsp;</div>',
        verticalCenter: true,
