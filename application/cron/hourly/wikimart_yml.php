...
require('E:\web\mladenec.beta\www\preload.php');

/**
 * Формирование YML файла для Wikimart
 */
...
$goodFiltersIds = [];
$image_types = '500';
for ($heap_number = 0; $goods = Model_Good::for_wikimart_yml($heap_size, $heap_number); $heap_number++){
    $c = 0;
    $good_ids = [];
    foreach ($goods as &$g) {
