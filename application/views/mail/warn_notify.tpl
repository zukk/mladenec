...
<table width="600" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
	<tr>
    {foreach from=$goods key=i item=g name=g}
		{if $i eq 3}
		</tr>
	</table>
<table width="600" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
    ...
    <td class="g {if $short}short{/if}" style="float:left; width:170px; margin:0 0 20px 12px; border-radius:5px; border:2px solid #ebebeb; position:relative; list-style:none; background:#fff;font: normal 12px/16px Verdana, Tahoma, Geneva, sans-serif;{if $short}height:auto; min-height:259px;{/if}">
