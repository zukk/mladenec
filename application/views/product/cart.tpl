...
<div id="cart-wrap">
    <h1>Корзина</h1>
    <p style="width:50%">
        Вниманию жителей Москвы!<br />
        В&nbsp;связи с&nbsp;ограничением движения автотранспорта на&nbsp;время проведения мероприятий,
        приуроченных к&nbsp;празднованию Дня города Москвы, 10 и&nbsp;11 сентября возможно увеличение интервала доставки в&nbsp;центральные районы города.
