...
<div id="cart-wrap">
    <h1>Корзина</h1>
    <p style="width:750px">
        <b>Вниманию жителей Москвы!</b><br />
        В&nbsp;связи с&nbsp;ограничением движения автотранспорта на&nbsp;время проведения мероприятий,
        приуроченных к&nbsp;празднованию Дня города Москвы, <b>10 и&nbsp;11 сентября</b> возможно увеличение интервала доставки в&nbsp;центральные районы города.
        Подробную информацию вы&nbsp;можете получить по&nbsp;телефонам: <nobr>8 (800) 555-699-4</nobr>, <nobr>+7 (495) 662-999-4</nobr>
    </p>
